...
//                    $('#'+gridobj).setGridWidth(parent.width());//宽度自适当
            ...
            return html + js + (IsInit ? callJs : "") + HtmlCalljs + OpenBuilder.ToString();
        }
        ...
        private static string FormOperForList(Sys_Config_ListPage M_Model, List<Sys_Config_Fieled> D_List)
        {
            ...
            function {preFix}ToolBarSearch() {
                
                {preFix}_GridControl.Search();         
            }          
          ";
            #endregion.
...
+ "'");
            ...
            )
        {
            ...
            //{
            //    M_Model.M_ToolBar = ToolBarConfig;
            //    html += helper.Common_ToolBarForListPage(CustNameSpace, ToolBarConfig);
            //}
