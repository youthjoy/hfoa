...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_Asset_MApply
   {

        private ADOAsset_MApply instance = new ADOAsset_MApply();
        ...
        {
            List<Asset_MApply> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<Asset_MApply> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Asset_MApply model,bool IsValid)
        {
