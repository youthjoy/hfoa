...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_PU_Main
   {

        private ADOPU_Main instance = new ADOPU_Main();
        ...
        {
            List<PU_Main> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<PU_Main> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(PU_Main model,bool IsValid)
        {
