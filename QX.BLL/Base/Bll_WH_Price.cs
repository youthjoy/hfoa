...
{
   [Serializable]
   public partial class Bll_WH_Price
   {

        private ADOWH_Price instance = new ADOWH_Price();
        ...
        {
            List<WH_Price> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<WH_Price> GetListByCode(string strCondition)
        {
