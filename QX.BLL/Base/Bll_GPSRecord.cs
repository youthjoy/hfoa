...
{
   [Serializable]
   public partial class Bll_GPSRecord
   {

        private ADOGPSRecord instance = new ADOGPSRecord();
        ...
        {
            List<GPSRecord> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<GPSRecord> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(GPSRecord model,bool IsValid)
        {
