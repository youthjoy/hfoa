...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_WH_IOMain
   {

        private ADOWH_IOMain instance = new ADOWH_IOMain();
        ...
        {
            List<WH_IOMain> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<WH_IOMain> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(WH_IOMain model,bool IsValid)
        {
