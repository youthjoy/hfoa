...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_WH_Movement
   {
        ...
        /// <returns>list</returns>
        public List<WH_Movement> GetListByCode(string strCondition)
        {
        ...
        /// <returns>bool</returns>
        public bool Insert(WH_Movement model,bool IsValid)
        { 
        ...
        /// <param name='strCondition'>条件(AND Code='11')</param>
        /// <returns>model</returns>
        public WH_Movement GetModel(int id)
        {
            WH_Movement model = instance.GetByKey(id);          
            return model;
        }    
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(WH_Movement model,bool IsValid)
        {
        ...
        {
            bool result = false;
            List<WH_Movement> list = instance.GetListByWhere(Condition);
            if (list.Count > 0)
            {
