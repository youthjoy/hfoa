...
{
   [Serializable]
   public partial class Bll_Assets_Apply
   {

        private ADOAssets_Apply instance = new ADOAssets_Apply();
        ...
        {
            List<Assets_Apply> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<Assets_Apply> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Assets_Apply model,bool IsValid)
        {
