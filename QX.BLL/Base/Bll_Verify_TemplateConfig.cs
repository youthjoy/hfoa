...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_Verify_TemplateConfig
   {
        ...
        {
            List<Verify_TemplateConfig> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<Verify_TemplateConfig> GetListByCode(string strCondition)
        {
