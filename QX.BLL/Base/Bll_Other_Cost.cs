...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_Other_Cost
   {

        private ADOOther_Cost instance = new ADOOther_Cost();
        ...
        {
            List<Other_Cost> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<Other_Cost> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Other_Cost model,bool IsValid)
        {
