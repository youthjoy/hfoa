...
namespace QX.BLL
{
   ...
   public partial class Bll_Bse_Attachments
   {
        ...
        private ADOBse_Attachments instance = new ADOBse_Attachments();
        ...
        /// <returns>list</returns>
        public List<Bse_Attachments> GetListByCode(string strCondition)
        {
        ...
        /// <returns>bool</returns>
        public bool Insert(Bse_Attachments model,bool IsValid)
        { 
        ...
        /// <param name='strCondition'>条件(AND Code='11')</param>
        /// <returns>model</returns>
        public Bse_Attachments GetModel(int id)
        {
            Bse_Attachments model = instance.GetByKey(id);          
            return model;
        }    
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(Bse_Attachments model,bool IsValid)
        {
        ...
        {
            bool result = false;
            List<Bse_Attachments> list = instance.GetListByWhere(Condition);
            if (list.Count > 0)
            {
