...
namespace QX.BLL
{
   ...
   public partial class Bll_BSE_SysInfo
   {
        ...
        private ADOBSE_SysInfo instance = new ADOBSE_SysInfo();
        ...
        /// <returns>list</returns>
        public List<BSE_SysInfo> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(BSE_SysInfo model,bool IsValid)
        {
