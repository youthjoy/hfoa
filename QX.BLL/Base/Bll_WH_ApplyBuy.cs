...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_WH_ApplyBuy
   {

        private ADOWH_ApplyBuy instance = new ADOWH_ApplyBuy();
        ...
        {
            List<WH_ApplyBuy> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<WH_ApplyBuy> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(WH_ApplyBuy model,bool IsValid)
        {
