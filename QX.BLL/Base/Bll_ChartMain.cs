...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_ChartMain
   {
        ...
        {
            List<ChartMain> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<ChartMain> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(ChartMain model,bool IsValid)
        {
