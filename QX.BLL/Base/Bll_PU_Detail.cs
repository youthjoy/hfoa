...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_PU_Detail
   {

        private ADOPU_Detail instance = new ADOPU_Detail();
        ...
        {
            List<PU_Detail> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<PU_Detail> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(PU_Detail model,bool IsValid)
        {
