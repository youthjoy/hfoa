...
{
   [Serializable]
   public partial class Bll_DisplayPage_Config
   {

        private ADODisplayPage_Config instance = new ADODisplayPage_Config();
        ...
        {
            List<DisplayPage_Config> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<DisplayPage_Config> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(DisplayPage_Config model,bool IsValid)
        {
