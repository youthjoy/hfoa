...
namespace QX.BLL
{
   ...
   /// </summary>
   [Serializable]
   public partial class Bll_DeptEmployee
   {

        private ADODeptEmployee instance = new ADODeptEmployee();
        ...
        {
            List<DeptEmployee> list = instance.GetAll();
            return list;
        }
        ...
        /// <returns>list</returns>
        public List<DeptEmployee> GetListByCode(string strCondition)
        {
        ...
        /// <param name='model'>实体</param>
        /// <returns>bool</returns>
        public bool Update(DeptEmployee model,bool IsValid)
        {
